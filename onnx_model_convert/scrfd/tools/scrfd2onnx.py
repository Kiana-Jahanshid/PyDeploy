...
if __name__ == '__main__':
    ...
    pytorch2onnx(
        args.config,
        args.checkpoint,
        input_img="data/retinaface/train/images/7--Cheering/7_Cheering_Cheering_7_27.jpg",
        input_shape=[640 , 640],
        opset_version=11,
        show=False,
        output_file="models/CRFD2ONNX.onnx" ,
        verify=False,
        simplify = True,
        dynamic = False,
        normalize_cfg=None,
        dataset='./data/retinaface/train/images',
        test_img="ME.jpg")
